...
from mmlib.probe import ProbeInfo, probe_inference, print_summary, compare_summaries, probe_training


def summary():
    model = models.vgg19(pretrained=True)
    summary_info = [ProbeInfo.LAYER, ProbeInfo.INPUT_SHAPE, ProbeInfo.INPUT_HASH, ProbeInfo.OUTPUT_SHAPE,
    ...
    # print the info from the summary that is specified by summary_info
    print_summary(summary, summary_info)
