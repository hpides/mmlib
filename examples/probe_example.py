...
from mmlib.model_equal import equal, whitebox_equal, blackbox_equal
...
def deterministic_backward_compare(device, forward_indices=None):
    ...
    blackbox_equal = blackbox_equal(model1, model2, imagenet_input)
    whitebox_equal = whitebox_equal(model1, model2)
    models_are_equal = equal(model1, model2, imagenet_input)
    print()
